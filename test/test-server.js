...
describe('Recipes', function(){
  ...
  // POST method testing
  it('should return update items', function(){
    const newItem = {name: "new recipe", ingredients: ['onion', 'egg', 'water']};
    return chai
      .request(app)
      .post('/recipes')
      .send(newItem)
  ...
  // PUT method testing
  it('should update a recipe successfully', function(){
    const recipe = {
      name: "new recipe", 
      ingredients: ["eggs", "water", "flower"]
    };
  ...
  // delete testing
  it('should delete a recipe successfully', function(){
